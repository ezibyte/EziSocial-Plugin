...
def dumpUsage():
    ...
    print "  -language  PROGRAMING_LANGUAGE   Major programing lanauge you want to used, should be [cpp]"
    print ""
    print "Sample 1: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame"
    print "Sample 2: ./create_project.py -project MyGame -package com.MyCompany.AwesomeGame -language cpp"
    print ""
...
def checkParams(context):
    ...
    if ("cpp" == context["language"]):
        ...
        context["src_project_path"] = os.getcwd() + "/../../template/multi-platform-cpp-ezisocial"
        platforms_list = ["ios",
                          "android"]
