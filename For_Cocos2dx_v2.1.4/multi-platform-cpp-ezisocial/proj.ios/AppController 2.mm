...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {    
    ...
    //[[EziSocialManager sharedManager] setAutoCheckIncomingOnAppActiveOrLoginSuccess:YES];
...
- (void)applicationDidBecomeActive:(UIApplication *)application {
    ...
    [[EziSocialManager sharedManager] handleApplicationDidBecomeActive]; // Newly Added Line
}
